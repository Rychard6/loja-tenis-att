export default function CorpoDetalhes(){
    return(
        <>
        <div className="block pl-28 pt-40 min-h-screen justify-center">
            ...
            <div className=" w-2/5 h-auto flex justify-center items-center border-none rounded-bl-lg rounded-r-lg">
